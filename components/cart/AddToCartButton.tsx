...
type AddToCartButtonProps = {
  product: ProductRow;
  /** Card grid: single button only (qty 1). Expanded panel uses default. */
  layout?: "default" | "compact";
};

export function AddToCartButton({ product, layout = "default" }: AddToCartButtonProps) {
  ...
  return (
    <div
      className={
        compact ?
          "product-card-mini__cart flex w-full flex-col items-center gap-2"
    ...
    >
      ...
      <button
        type="button"
        className={compact ? "btn btn--primary w-full max-w-full justify-center" : "btn btn--primary"}
        disabled={!canBuy}
        onClick={onClick}
      >
