...
export default async function AdminReviewsPage() {
  ...
  return (
    <div className="space-y-6 max-[375px]:space-y-4">
      <div>
        <h1 className="font-serif text-2xl font-semibold text-[var(--color-bg-deep)] max-[375px]:text-xl">Reviews</h1>
        <p className="mt-1 text-sm text-admin-muted max-[375px]:text-xs">
          Approve or reject customer feedback for homepage display.
        </p>
      </div>
      {error && (
